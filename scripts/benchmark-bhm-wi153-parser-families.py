#!/usr/bin/env python
"""Bounded parser benchmark for WI-153 AWK/GDScript/Janet identities."""
...
def run(iterations: int = 1000) -> dict[str, object]:
    ...
    result: dict[str, object] = {
        "schema_version": "bhm.p28.wi153.parser-families-benchmark.v1",
