...
DISPOSITIONS = {
    ...
    "OVG": ("reference-only", "closed hosted product; acceptance criteria only, with no external runtime dependency", ["src/blackholememory/human_ui_bridge.py", "tests/integration/test_human_ui.py"]),
    ...
    "OBS": ("reference-only", "Obsidian is an optional Markdown review surface and never a BHM authority or runtime dependency", ["src/blackholememory/human_ui_bridge.py", "tests/integration/test_human_ui.py"]),
