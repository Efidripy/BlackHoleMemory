...
ENTRIES = [
    ...
    {"tool": "Shell and validators", "status": "used", "action": "read-only gates, source passport, P21.13–P21.18 evidence validators", "evidence": ["scripts/validate-bhm-source-passport.py", "scripts/validate-bhm-p21.18-source-freeze.py"]},
