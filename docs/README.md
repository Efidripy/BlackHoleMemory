...
- [Historical trace classification](architecture-authority.md#current-state-and-historical-trace-retrieval) — current state versus checkpoint/session provenance.
