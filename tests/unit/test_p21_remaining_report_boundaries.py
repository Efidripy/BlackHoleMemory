...
def test_p21_remaining_report_writer_rejects_hardlink_target(module, tmp_path: Path) -> None:
...
@pytest.mark.parametrize("module", MODULES)
def test_p21_remaining_report_writer_creates_nested_json(module, tmp_path: Path) -> None:
