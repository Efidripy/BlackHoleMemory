...
def test_surface_report_exposes_current_inventory_without_deletion():
    ...
    # Governed policy-preflight, shared-read, and the eight operator-only
    # governed-consolidation tools are intentional additions to the
    # historical CBM-parity surface.
    assert payload["inventory"]["mcp_registered"] == 202
